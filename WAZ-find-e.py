...
for n in range(len(ancho)):
    ...
    for i in range(x.shape[0]):
        color = '0.5'
        if(suma(dens[i,:],x[i,:],-3-11.25*(1+ancho[n]/100),-11.25*(1+ancho[n]/100)) > suma(dens[int(p1b_e[3]),:],x[int(p1b_e[3]),:],-3-11.25*(1+ancho[n]/100),-11.25*(1+ancho[n]/100))) :
            p1b_e[3] = i
...
#find e2b_e
    ...
    for i in range(x.shape[0]):
        color = '0.5'
        if(suma(dens[i,:],x[i,:],-3-11.25*(1+ancho[n]/100),-11.25*(1+ancho[n]/100)) > suma(dens[int(e2b_e[3]),:],x[int(e2b_e[3]),:],-3-11.25*(1+ancho[n]/100),-11.25*(1+ancho[n]/100))) :
            e2b_e[3] = i
